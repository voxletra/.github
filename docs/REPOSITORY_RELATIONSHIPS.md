...
# Repository relationships for `voxletra`
...
- Inventory digest: `sha256:76edf2f470b6f5224ed252764ec59e821af591436f4f5c19b7fee06b21bc3884`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:voxletra` |
| GitHub owner ID | `308588098` |
| Linear project ID | `d45b6c31-6b98-467b-8440-e3c3480613fb` |
...
|---|---|---|---|
| `voxletra/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
