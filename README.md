# voxletra organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`voxletra`](https://github.com/voxletra).

## Canonical organization links

- GitHub organization: https://github.com/voxletra
- Public organization defaults: https://github.com/voxletra/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomvoxletra-5528d72e4a7d
...
`voxletra` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
